...
export default function Home() {
  return (
    <>
      ...
      {/* Features Section */}
      <div className="w-full bg-white dark:bg-gray-900 py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <motion.div
              ...
              className="p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
            >
      ...
      {/* CTA Section */}
      <div className="w-full bg-gray-50 dark:bg-gray-950 py-24 px-6">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
      ...
      {/* Footer */}
      <footer className="w-full bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 py-12 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            {/* Logo and Description */}
            <div className="md:col-span-1">
              <svg
                className="w-32 mb-4 fill-gray-900 dark:fill-gray-100"
                viewBox="0 0 749 202"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
